...
public class ViewFinderView extends View implements IViewFinder {
    ...
    private final int mDefaultLaserColor = getResources().getColor(R.color.a_2);
    private final int mDefaultMaskColor = getResources().getColor(R.color.viewfinder_mask);
    private final int mDefaultBorderColor = getResources().getColor(R.color.a_2);
    private final int mDefaultBorderCenterColor = getResources().getColor(R.color.a_2);
    private final int mDefaultBorderStrokeWidth = getResources().getInteger(R.integer.viewfinder_border_width);
    private final int mDefaultBorderCenterStrokeWidth = getResources().getInteger(R.integer.viewfinder_border_center_width);
    private final int mDefaultBorderLineLength = getResources().getInteger(R.integer.viewfinder_border_length);
    private final int mDefaultcenterineLength = getResources().getInteger(R.integer.viewfinder_center_line_length);

    protected Paint mLaserPaint;
    protected Paint mFinderMaskPaint;
    protected Paint mBorderPaint;
    protected Paint mBorderCenterPaint;
    protected int mBorderLineLength;
    protected int mCenterLineLength;
    ...
    private void init() {
        ...
        mBorderCenterPaint = new Paint();
        mBorderCenterPaint.setColor(mDefaultBorderCenterColor);
        mBorderCenterPaint.setStyle(Paint.Style.STROKE);
        mBorderCenterPaint.setStrokeWidth(mDefaultBorderCenterStrokeWidth);
//        mBorderCenterPaint.setAntiAlias(true);

        mBorderLineLength = mDefaultBorderLineLength;
        mCenterLineLength = mDefaultcenterineLength;
    }
    ...
    public void drawViewFinderBorder(Canvas canvas) {
        ...
        path.moveTo(framingRect.centerX(),framingRect.top - mCenterLineLength);
        path.lineTo(framingRect.centerX(), framingRect.top + mCenterLineLength);
        canvas.drawPath(path, mBorderCenterPaint);

//        bottom center

        path.moveTo(framingRect.centerX(),framingRect.bottom - mCenterLineLength);
        path.lineTo(framingRect.centerX(), framingRect.bottom + mCenterLineLength);
        canvas.drawPath(path, mBorderCenterPaint);

//        right center

        path.moveTo(framingRect.right + mCenterLineLength,framingRect.centerY());
        path.lineTo(framingRect.right - mCenterLineLength, framingRect.centerY());
        canvas.drawPath(path, mBorderCenterPaint);

//        left center

        path.moveTo(framingRect.left - mCenterLineLength, framingRect.centerY());
        path.lineTo(framingRect.left + mCenterLineLength, framingRect.centerY());
        canvas.drawPath(path, mBorderCenterPaint);
    }
